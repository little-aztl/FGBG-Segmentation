...
class InitialWeightHelper:
    ...
    def __init__(self, img_gray, initial_mask):
        ...
        initial_mask: (H, W)
        '''
        self.img = img_gray.copy()
        self.img_flatten = self.img.reshape(-1) # (H*W,)
    ...
    def get_initial_weight(self):
        ...
        foreground_bin_index[foreground_bin_index == InitialWeightHelper.BINS + 1] = InitialWeightHelper.BINS
        ...
        background_bin_index[background_bin_index == InitialWeightHelper.BINS + 1] = InitialWeightHelper.BINS
